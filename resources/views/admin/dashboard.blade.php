...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="page-subtle mb-0">Operational overview for elections, voters, and turnout.</p>
        </div>
    </div>
    ...
    <div class="card surface-card">
        <div class="card-body">
            <h2 class="h4 mb-3">Recent Elections</h2>
                ...
                <table class="table">
                    ...
                    @forelse ($recentElections as $election)
                        <tr>
                            ...
                            <td><a class="btn btn-sm btn-outline-primary" href="{{ route('admin.elections.contests.index', $election) }}">Manage</a></td>
                        </tr>
                    @empty
                        <tr><td colspan="5" class="text-muted">No elections found.</td></tr>
                    @endforelse
                    </tbody>
                </table>
            </div>
